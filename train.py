...
parser.add_argument('-early-stopping', type=int, default=10000, help='早停时迭代的次数')
...
def train(args):
    ...
    for epoch in range(1, args.epoch + 1):
        for batch in train_iter:
            ...
            feature.data=feature.data.permute(1,0)
            ...
            logits2 = model(feature)
            loss_2 = F.cross_entropy(logits2, target)
            loss_2.backward()  # 反向传播，并在正常的grad基础上，累加对抗训练的梯度
